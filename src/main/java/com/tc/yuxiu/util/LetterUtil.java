...
public class LetterUtil {
    ...
    public static String getAllFirstLetter(String str) {
        ...
        for (int i = 0; i < str.length(); i++) {
            _str = _str + getFirstLetter(str.substring(i, i + 1)).toString();
        }
     ...
     * @return 给定汉字的声母
     */
    public static Character getFirstLetter(String chinese) {
    ...
    public static void main(String[] args) {
        String test = "火星";
        String allFirstLetter = LetterUtil.getAllFirstLetter( test);
        Character firstLetter = LetterUtil.getFirstLetter(test);
        System.out.println(allFirstLetter+" "+firstLetter.toString());
    }
